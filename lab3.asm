...
int main(int argc, char *argv[])
{
	...
	recursive(10);
    1009:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
    1010:	e8 0b 00 00 00       	call   1020 <recursive>
...
void recursive(int n){
    ...
    1023:	56                   	push   %esi
	if(n%100000 == 0) printf(1, "%d \n",n);
    1024:	be 89 b5 f8 14       	mov    $0x14f8b589,%esi
		}
                     printf(1,"\n if processes with highest priority finished first then its correct \n");
}
...
void recursive(int n){
    1029:	53                   	push   %ebx
    102a:	83 ec 10             	sub    $0x10,%esp
    102d:	8b 5d 08             	mov    0x8(%ebp),%ebx
    1030:	eb 09                	jmp    103b <recursive+0x1b>
...
void recursive(int n){
	if(n%100000 == 0) printf(1, "%d \n",n);
    103b:	89 d8                	mov    %ebx,%eax
    103d:	f7 ee                	imul   %esi
    103f:	89 d8                	mov    %ebx,%eax
    1041:	c1 f8 1f             	sar    $0x1f,%eax
    1044:	c1 fa 0d             	sar    $0xd,%edx
    1047:	29 c2                	sub    %eax,%edx
    1049:	69 d2 a0 86 01 00    	imul   $0x186a0,%edx,%edx
    104f:	39 d3                	cmp    %edx,%ebx
    1051:	75 e5                	jne    1038 <recursive+0x18>
    1053:	89 5c 24 08          	mov    %ebx,0x8(%esp)
    1057:	c7 44 24 04 91 17 00 	movl   $0x1791,0x4(%esp)
    105e:	00 
    105f:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    1066:	e8 85 03 00 00       	call   13f0 <printf>
    106b:	eb cb                	jmp    1038 <recursive+0x18>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1389:	0f b6 92 9d 17 00 00 	movzbl 0x179d(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    151f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
    1521:	b8 96 17 00 00       	mov    $0x1796,%eax

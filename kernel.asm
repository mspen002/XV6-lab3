...
80100b72:	0f 84 a5 01 00 00    	je     80100d1d <exec+0x37d>
...
80100bef:	e8 fc 60 00 00       	call   80106cf0 <copyout>
...
80100c6d:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)
  ...
  sp -= (3+argc+1) * 4;
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c73:	e8 78 60 00 00       	call   80106cf0 <copyout>
...
80100cba:	83 c0 74             	add    $0x74,%eax
...
80100ccb:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
  ...
  // Commit to the user image.
  oldpgdir = curproc->pgdir;
80100cd1:	8b 77 0c             	mov    0xc(%edi),%esi
  curproc->pgdir = pgdir;
  curproc->sz = sz;
...
80100ce5:	89 07                	mov    %eax,(%edi)
  ...
  curproc->sz = sz;
  curproc->st = (uint)PGROUNDDOWN(sp);
80100ce7:	89 d8                	mov    %ebx,%eax
80100ce9:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80100cee:	89 47 04             	mov    %eax,0x4(%edi)
  curproc->numPages = 1;
  curproc->tf->eip = elf.entry;  // main
80100cf1:	8b 47 20             	mov    0x20(%edi),%eax
      last = s+1;
  safestrcpy(curproc->name, last, sizeof(curproc->name));
  ...
  oldpgdir = curproc->pgdir;
  curproc->pgdir = pgdir;
80100cf4:	89 57 0c             	mov    %edx,0xc(%edi)
  curproc->sz = sz;
  curproc->st = (uint)PGROUNDDOWN(sp);
  curproc->numPages = 1;
  curproc->tf->eip = elf.entry;  // main
80100cf7:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100cfd:	89 50 38             	mov    %edx,0x38(%eax)
  curproc->tf->esp = sp;
80100d00:	8b 47 20             	mov    0x20(%edi),%eax
80100d03:	89 58 44             	mov    %ebx,0x44(%eax)
  switchuvm(curproc);
80100d06:	89 3c 24             	mov    %edi,(%esp)
80100d09:	e8 12 59 00 00       	call   80106620 <switchuvm>
  freevm(oldpgdir);
80100d0e:	89 34 24             	mov    %esi,(%esp)
80100d11:	e8 8a 5c 00 00       	call   801069a0 <freevm>
  return 0;
80100d16:	31 c0                	xor    %eax,%eax
80100d18:	e9 f5 fc ff ff       	jmp    80100a12 <exec+0x72>
    goto bad;
  //clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
  sp = STACKTOP;
  ...
  // Push argument strings, prepare rest of stack in ustack.
  for(argc = 0; argv[argc]; argc++) {
80100d1d:	bb fc ff ff 7f       	mov    $0x7ffffffc,%ebx
80100d22:	31 d2                	xor    %edx,%edx
80100d24:	8d 8d 58 ff ff ff    	lea    -0xa8(%ebp),%ecx
80100d2a:	e9 fe fe ff ff       	jmp    80100c2d <exec+0x28d>
80100d2f:	90                   	nop
...
80100d36:	c7 44 24 04 8d 6e 10 	movl   $0x80106e8d,0x4(%esp)
80100d3d:	80 
...
filedup(struct file *f)
{
  ...
  if(f->ref < 1)
    panic("filedup");
80100df7:	c7 04 24 94 6e 10 80 	movl   $0x80106e94,(%esp)
...
80100eb7:	e9 b4 1c 00 00       	jmp    80102b70 <end_op>
{
  ...
  if(f->ref < 1)
    panic("fileclose");
80100ebc:	c7 04 24 9c 6e 10 80 	movl   $0x80106e9c,(%esp)
...
80100fa5:	eb d8                	jmp    80100f7f <fileread+0x5f>
  ...
  panic("fileread");
80100fa7:	c7 04 24 a6 6e 10 80 	movl   $0x80106ea6,(%esp)
...
801010bc:	e9 1f 22 00 00       	jmp    801032e0 <pipewrite>
      ...
      if(r != n1)
        panic("short filewrite");
801010c1:	c7 04 24 af 6e 10 80 	movl   $0x80106eaf,(%esp)
801010c8:	e8 93 f2 ff ff       	call   80100360 <panic>
  ...
  panic("filewrite");
801010cd:	c7 04 24 b5 6e 10 80 	movl   $0x80106eb5,(%esp)
...
80101185:	c7 04 24 bf 6e 10 80 	movl   $0x80106ebf,(%esp)
...
801012ac:	c3                   	ret    
  ...
  if(empty == 0)
    panic("iget: no inodes");
801012ad:	c7 04 24 d5 6e 10 80 	movl   $0x80106ed5,(%esp)
...
80101365:	eb 93                	jmp    801012fa <bmap+0x3a>
  ...
  panic("bmap: out of range");
80101367:	c7 04 24 e5 6e 10 80 	movl   $0x80106ee5,(%esp)
...
80101448:	c3                   	ret    
  ...
  if((bp->data[bi/8] & m) == 0)
    panic("freeing free block");
80101449:	c7 04 24 f8 6e 10 80 	movl   $0x80106ef8,(%esp)
...
8010146c:	c7 44 24 04 0b 6f 10 	movl   $0x80106f0b,0x4(%esp)
80101473:	80 
...
80101489:	c7 44 24 04 12 6f 10 	movl   $0x80106f12,0x4(%esp)
80101490:	80 
...
801014b6:	c7 04 24 78 6f 10 80 	movl   $0x80106f78,(%esp)
...
801015cc:	e9 2f fc ff ff       	jmp    80101200 <iget>
  ...
  panic("ialloc: no inodes");
801015d1:	c7 04 24 18 6f 10 80 	movl   $0x80106f18,(%esp)
...
80101754:	0f 85 76 ff ff ff    	jne    801016d0 <ilock+0x30>
      panic("ilock: no type");
8010175a:	c7 04 24 30 6f 10 80 	movl   $0x80106f30,(%esp)
80101761:	e8 fa eb ff ff       	call   80100360 <panic>
{
  ...
  if(ip == 0 || ip->ref < 1)
    panic("ilock");
80101766:	c7 04 24 2a 6f 10 80 	movl   $0x80106f2a,(%esp)
...
iunlock(struct inode *ip)
{
  if(ip == 0 || !holdingsleep(&ip->lock) || ip->ref < 1)
    panic("iunlock");
801017b3:	c7 04 24 3f 6f 10 80 	movl   $0x80106f3f,(%esp)
...
80101c51:	c3                   	ret    
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlookup read");
80101c52:	c7 04 24 59 6f 10 80 	movl   $0x80106f59,(%esp)
80101c59:	e8 02 e7 ff ff       	call   80100360 <panic>
{
  ...
  if(dp->type != T_DIR)
    panic("dirlookup not DIR");
80101c5e:	c7 04 24 47 6f 10 80 	movl   $0x80106f47,(%esp)
...
80101ed3:	eb e9                	jmp    80101ebe <dirlink+0xae>
  ...
  for(off = 0; off < dp->size; off += sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("dirlink read");
80101ed5:	c7 04 24 68 6f 10 80 	movl   $0x80106f68,(%esp)
80101edc:	e8 7f e4 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("dirlink");
80101ee1:	c7 04 24 66 75 10 80 	movl   $0x80107566,(%esp)
...
80101fcf:	c7 04 24 d4 6f 10 80 	movl   $0x80106fd4,(%esp)
...
idestart(struct buf *b)
{
  if(b == 0)
    panic("idestart");
80101fdb:	c7 04 24 cb 6f 10 80 	movl   $0x80106fcb,(%esp)
...
80101ff6:	c7 44 24 04 e6 6f 10 	movl   $0x80106fe6,0x4(%esp)
80101ffd:	80 
...
iderw(struct buf *b)
{
  ...
  if(!holdingsleep(&b->lock))
    panic("iderw: buf not locked");
801021cb:	c7 04 24 ea 6f 10 80 	movl   $0x80106fea,(%esp)
801021d2:	e8 89 e1 ff ff       	call   80100360 <panic>
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
  if(b->dev != 0 && !havedisk1)
    panic("iderw: ide disk 1 not present");
801021d7:	c7 04 24 15 70 10 80 	movl   $0x80107015,(%esp)
801021de:	e8 7d e1 ff ff       	call   80100360 <panic>
  ...
  if((b->flags & (B_VALID|B_DIRTY)) == B_VALID)
    panic("iderw: nothing to do");
801021e3:	c7 04 24 00 70 10 80 	movl   $0x80107000,(%esp)
...
80102238:	c7 04 24 34 70 10 80 	movl   $0x80107034,(%esp)
...
kfree(char *v)
{
  ...
  if((uint)v % PGSIZE || v < end || V2P(v) >= PHYSTOP)
    panic("kfree");
8010236e:	c7 04 24 66 70 10 80 	movl   $0x80107066,(%esp)
...
801023db:	c7 44 24 04 6c 70 10 	movl   $0x8010706c,0x4(%esp)
801023e2:	80 
...
80102524:	0f b6 81 a0 71 10 80 	movzbl -0x7fef8e60(%ecx),%eax
...
80102558:	0f b6 91 a0 71 10 80 	movzbl -0x7fef8e60(%ecx),%edx
  shift ^= togglecode[data];
8010255f:	0f b6 81 a0 70 10 80 	movzbl -0x7fef8f60(%ecx),%eax
    // Last character was an E0 escape; or with 0x80
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
8010256f:	8b 04 85 80 70 10 80 	mov    -0x7fef8f80(,%eax,4),%eax
    data |= 0x80;
    shift &= ~E0ESC;
  }
...
80102a6b:	c7 44 24 04 a0 72 10 	movl   $0x801072a0,0x4(%esp)
80102a72:	80 
...
80102c92:	c3                   	ret    
  ...
  if(log.committing)
    panic("log.committing");
80102c93:	c7 04 24 a4 72 10 80 	movl   $0x801072a4,(%esp)
...
log_write(struct buf *b)
{
  ...
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
    panic("too big a transaction");
80102d50:	c7 04 24 b3 72 10 80 	movl   $0x801072b3,(%esp)
80102d57:	e8 04 d6 ff ff       	call   80100360 <panic>
  if (log.outstanding < 1)
    panic("log_write outside of trans");
80102d5c:	c7 04 24 c9 72 10 80 	movl   $0x801072c9,(%esp)
...
80102d87:	c7 04 24 e4 72 10 80 	movl   $0x801072e4,(%esp)
80102d8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80102d92:	e8 b9 d8 ff ff       	call   80100650 <cprintf>
  idtinit();       // load idt register
80102d97:	e8 74 27 00 00       	call   80105510 <idtinit>
...
80102dc3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dc6:	e8 35 38 00 00       	call   80106600 <switchkvm>
  seginit();
80102dcb:	e8 f0 36 00 00       	call   801064c0 <seginit>
  lapicinit();
...
80102e03:	e8 a8 3c 00 00       	call   80106ab0 <kvmalloc>
...
80102e15:	e8 a6 36 00 00       	call   801064c0 <seginit>
  picinit();       // disable pic
...
80102e2a:	e8 31 2a 00 00       	call   80105860 <uartinit>
80102e2f:	90                   	nop
  pinit();         // process table
80102e30:	e8 9b 07 00 00       	call   801035d0 <pinit>
  shminit();       // shared memory
80102e35:	e8 46 3f 00 00       	call   80106d80 <shminit>
  tvinit();        // trap vectors
80102e3a:	e8 31 26 00 00       	call   80105470 <tvinit>
80102e3f:	90                   	nop
  binit();         // buffer cache
...
80102f2f:	00 
80102f30:	c7 44 24 04 f8 72 10 	movl   $0x801072f8,0x4(%esp)
80102f37:	80 
...
80102fea:	00 
80102feb:	c7 44 24 04 fd 72 10 	movl   $0x801072fd,0x4(%esp)
80102ff2:	80 
...
8010307c:	ff 24 8d 3c 73 10 80 	jmp    *-0x7fef8cc4(,%ecx,4)
80103083:	90                   	nop
...
80103107:	0f 85 c5 fe ff ff    	jne    80102fd2 <mpinit+0x52>
  ...
  if((conf = mpconfig(&mp)) == 0)
    panic("Expect to run on an SMP");
8010310d:	c7 04 24 02 73 10 80 	movl   $0x80107302,(%esp)
...
80103128:	eb e3                	jmp    8010310d <mpinit+0x18d>
  ...
  if(!ismp)
    panic("Didn't find a suitable machine");
8010312a:	c7 04 24 1c 73 10 80 	movl   $0x8010731c,(%esp)
...
801031cf:	c7 44 24 04 50 73 10 	movl   $0x80107350,0x4(%esp)
801031d6:	80 
...
80103520:	89 53 20             	mov    %edx,0x20(%ebx)
  ...
  sp -= 4;
  *(uint*)sp = (uint)trapret;
80103523:	c7 40 14 65 54 10 80 	movl   $0x80105465,0x14(%eax)
...
801035d6:	c7 44 24 04 55 73 10 	movl   $0x80107355,0x4(%esp)
801035dd:	80 
...
80103648:	eb ea                	jmp    80103634 <mycpu+0x44>
  ...
  panic("unknown apicid\n");
8010364a:	c7 04 24 5c 73 10 80 	movl   $0x8010735c,(%esp)
...
mycpu(void)
{
  ...
  if(readeflags()&FL_IF)
    panic("mycpu called with interrupts enabled\n");
80103656:	c7 04 24 38 74 10 80 	movl   $0x80107438,(%esp)
...
801036d3:	e8 48 33 00 00       	call   80106a20 <setupkvm>
...
801036f5:	80 
801036f6:	e8 35 30 00 00       	call   80106730 <inituvm>
  p->sz = PGSIZE;
...
80103772:	00 
80103773:	c7 44 24 04 85 73 10 	movl   $0x80107385,0x4(%esp)
8010377a:	80 
8010377b:	89 04 24             	mov    %eax,(%esp)
8010377e:	e8 fd 0c 00 00       	call   80104480 <safestrcpy>
  p->cwd = namei("/");
80103783:	c7 04 24 8e 73 10 80 	movl   $0x8010738e,(%esp)
...
801037b6:	c3                   	ret    
  ...
  if((p->pgdir = setupkvm()) == 0)
    panic("userinit: out of memory?");
801037b7:	c7 04 24 6c 73 10 80 	movl   $0x8010736c,(%esp)
...
801037f9:	e8 82 30 00 00       	call   80106880 <allocuvm>
...
80103807:	e8 14 2e 00 00       	call   80106620 <switchuvm>
  return 0;
...
8010382a:	e8 51 31 00 00       	call   80106980 <deallocuvm>
...
80103868:	8b 43 0c             	mov    0xc(%ebx),%eax
8010386b:	89 04 24             	mov    %eax,(%esp)
8010386e:	e8 8d 32 00 00       	call   80106b00 <copyuvm>
80103873:	85 c0                	test   %eax,%eax
80103875:	89 47 0c             	mov    %eax,0xc(%edi)
...
80103883:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
  *np->tf = *curproc->tf;
80103885:	8b 79 20             	mov    0x20(%ecx),%edi
80103888:	89 c8                	mov    %ecx,%eax
  ...
  np->sz = curproc->sz;
  np->parent = curproc;
8010388a:	89 59 1c             	mov    %ebx,0x1c(%ecx)
  *np->tf = *curproc->tf;
8010388d:	8b 73 20             	mov    0x20(%ebx),%esi
...
80103897:	31 f6                	xor    %esi,%esi
  ...
  *np->tf = *curproc->tf;
  ...
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
80103899:	8b 40 20             	mov    0x20(%eax),%eax
...
801038a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(i = 0; i < NOFILE; i++)
    if(curproc->ofile[i])
801038a8:	8b 44 b3 30          	mov    0x30(%ebx,%esi,4),%eax
...
801038bb:	89 44 b2 30          	mov    %eax,0x30(%edx,%esi,4)
  *np->tf = *curproc->tf;
...
801038c7:	8b 43 70             	mov    0x70(%ebx),%eax

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801038ca:	83 c3 74             	add    $0x74,%ebx
  np->tf->eax = 0;
...
801038d8:	89 47 70             	mov    %eax,0x70(%edi)

  safestrcpy(np->name, curproc->name, sizeof(curproc->name));
801038db:	8d 47 74             	lea    0x74(%edi),%eax
801038de:	89 5c 24 04          	mov    %ebx,0x4(%esp)
801038e2:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
801038e9:	00 
801038ea:	89 04 24             	mov    %eax,(%esp)
801038ed:	e8 8e 0b 00 00       	call   80104480 <safestrcpy>

  pid = np->pid;
801038f2:	8b 5f 18             	mov    0x18(%edi),%ebx

  acquire(&ptable.lock);
801038f5:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
801038fc:	e8 5f 08 00 00       	call   80104160 <acquire>

  np->state = RUNNABLE;
80103901:	c7 47 14 03 00 00 00 	movl   $0x3,0x14(%edi)

  release(&ptable.lock);
80103908:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
8010390f:	e8 3c 09 00 00       	call   80104250 <release>
...
80103928:	8b 47 10             	mov    0x10(%edi),%eax
...
80103933:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
  ...
  if((np->pgdir = copyuvm(curproc->pgdir, curproc->sz)) == 0){
    kfree(np->kstack);
    np->kstack = 0;
80103938:	c7 47 10 00 00 00 00 	movl   $0x0,0x10(%edi)
    np->state = UNUSED;
8010393f:	c7 47 14 00 00 00 00 	movl   $0x0,0x14(%edi)
    return -1;
...
80103994:	74 4a                	je     801039e0 <scheduler+0x90>
      if(p->state != RUNNABLE)
80103996:	83 7b 14 03          	cmpl   $0x3,0x14(%ebx)
...
801039a5:	81 c3 84 00 00 00    	add    $0x84,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039ab:	e8 70 2c 00 00       	call   80106620 <switchuvm>
      p->state = RUNNING;
...
801039b0:	8b 43 a0             	mov    -0x60(%ebx),%eax
      ...
      switchuvm(p);
      p->state = RUNNING;
801039b3:	c7 43 90 04 00 00 00 	movl   $0x4,-0x70(%ebx)
...
801039c1:	e8 15 0b 00 00       	call   801044db <swtch>
      switchkvm();
801039c6:	e8 35 2c 00 00       	call   80106600 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103a1b:	75 65                	jne    80103a82 <sched+0x92>
    panic("sched locks");
  if(p->state == RUNNING)
80103a1d:	83 7b 14 04          	cmpl   $0x4,0x14(%ebx)
...
80103a5d:	c3                   	ret    
{
  ...
  if(!holding(&ptable.lock))
    panic("sched ptable.lock");
80103a5e:	c7 04 24 90 73 10 80 	movl   $0x80107390,(%esp)
80103a65:	e8 f6 c8 ff ff       	call   80100360 <panic>
  ...
  if(readeflags()&FL_IF)
    panic("sched interruptible");
80103a6a:	c7 04 24 bc 73 10 80 	movl   $0x801073bc,(%esp)
80103a71:	e8 ea c8 ff ff       	call   80100360 <panic>
  ...
  if(p->state == RUNNING)
    panic("sched running");
80103a76:	c7 04 24 ae 73 10 80 	movl   $0x801073ae,(%esp)
80103a7d:	e8 de c8 ff ff       	call   80100360 <panic>
  ...
  if(mycpu()->ncli != 1)
    panic("sched locks");
80103a82:	c7 04 24 a2 73 10 80 	movl   $0x801073a2,(%esp)
...
80103af8:	8b 43 1c             	mov    0x1c(%ebx),%eax
static void
wakeup1(void *chan)
{
  struct proc *p;
...
80103b54:	74 3c                	je     80103b92 <exit+0x102>
    if(p->parent == curproc){
80103b56:	39 59 1c             	cmp    %ebx,0x1c(%ecx)
80103b59:	75 ed                	jne    80103b48 <exit+0xb8>
      p->parent = initproc;
      if(p->state == ZOMBIE)
80103b5b:	83 79 14 05          	cmpl   $0x5,0x14(%ecx)
  wakeup1(curproc->parent);
  ...
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->parent == curproc){
      p->parent = initproc;
80103b5f:	89 41 1c             	mov    %eax,0x1c(%ecx)
      if(p->state == ZOMBIE)
...
80103b92:	c7 43 14 05 00 00 00 	movl   $0x5,0x14(%ebx)
  sched();
80103b99:	e8 52 fe ff ff       	call   801039f0 <sched>
  panic("zombie exit");
80103b9e:	c7 04 24 dd 73 10 80 	movl   $0x801073dd,(%esp)
80103ba5:	e8 b6 c7 ff ff       	call   80100360 <panic>
  ...
  if(curproc == initproc)
    panic("init exiting");
80103baa:	c7 04 24 d0 73 10 80 	movl   $0x801073d0,(%esp)
...
80103bd7:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
  sched();
...
80103c3e:	89 7b 28             	mov    %edi,0x28(%ebx)
  p->state = SLEEPING;
80103c41:	c7 43 14 02 00 00 00 	movl   $0x2,0x14(%ebx)
...
80103c70:	89 78 28             	mov    %edi,0x28(%eax)
  p->state = SLEEPING;
80103c73:	c7 40 14 02 00 00 00 	movl   $0x2,0x14(%eax)
...
80103c8e:	c7 04 24 ef 73 10 80 	movl   $0x801073ef,(%esp)
...
sleep(void *chan, struct spinlock *lk)
{
  ...
  if(p == 0)
    panic("sleep");
80103c9a:	c7 04 24 e9 73 10 80 	movl   $0x801073e9,(%esp)
...
80103ce4:	74 22                	je     80103d08 <wait+0x58>
      if(p->parent != curproc)
80103ce6:	39 73 1c             	cmp    %esi,0x1c(%ebx)
80103ce9:	75 ed                	jne    80103cd8 <wait+0x28>
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
80103ceb:	83 7b 14 05          	cmpl   $0x5,0x14(%ebx)
...
80103d23:	eb a6                	jmp    80103ccb <wait+0x1b>
      ...
      if(p->state == ZOMBIE){
        ...
        pid = p->pid;
        kfree(p->kstack);
80103d25:	8b 43 10             	mov    0x10(%ebx),%eax
      if(p->parent != curproc)
        continue;
      havekids = 1;
      if(p->state == ZOMBIE){
...
80103d33:	8b 43 0c             	mov    0xc(%ebx),%eax
      ...
      if(p->state == ZOMBIE){
        ...
        kfree(p->kstack);
        p->kstack = 0;
80103d36:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        freevm(p->pgdir);
80103d3d:	89 04 24             	mov    %eax,(%esp)
80103d40:	e8 5b 2c 00 00       	call   801069a0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103d45:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        ...
        freevm(p->pgdir);
        p->pid = 0;
80103d4c:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->parent = 0;
80103d53:	c7 43 1c 00 00 00 00 	movl   $0x0,0x1c(%ebx)
        p->name[0] = 0;
80103d5a:	c6 43 74 00          	movb   $0x0,0x74(%ebx)
        p->killed = 0;
80103d5e:	c7 43 2c 00 00 00 00 	movl   $0x0,0x2c(%ebx)
        p->state = UNUSED;
80103d65:	c7 43 14 00 00 00 00 	movl   $0x0,0x14(%ebx)
        release(&ptable.lock);
...
80103e3a:	74 3c                	je     80103e78 <kill+0x68>
    if(p->pid == pid){
80103e3c:	39 58 18             	cmp    %ebx,0x18(%eax)
80103e3f:	75 ef                	jne    80103e30 <kill+0x20>
      p->killed = 1;
      // Wake process from sleep if necessary.
      if(p->state == SLEEPING)
80103e41:	83 78 14 02          	cmpl   $0x2,0x14(%eax)
  struct proc *p;
...
80103e62:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
    if(p->pid == pid){
      ...
      if(p->state == SLEEPING)
        p->state = RUNNABLE;
80103e68:	c7 40 14 03 00 00 00 	movl   $0x3,0x14(%eax)
...
80103ecd:	83 f8 05             	cmp    $0x5,%eax
      ...
      state = "???";
80103ed0:	ba 00 74 10 80       	mov    $0x80107400,%edx
  uint pc[10];
...
80103ed7:	8b 14 85 60 74 10 80 	mov    -0x7fef8ba0(,%eax,4),%edx
      state = states[p->state];
    else
      state = "???";
80103ede:	b8 00 74 10 80       	mov    $0x80107400,%eax
...
80103ef3:	c7 04 24 04 74 10 80 	movl   $0x80107404,(%esp)
...
80103fdd:	8b 40 18             	mov    0x18(%eax),%eax
...
80104513:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  if(addr >= STACKTOP)
80104516:	81 fa fb ff ff 7f    	cmp    $0x7ffffffb,%edx
...
801045b7:	3d fb ff ff 7f       	cmp    $0x7ffffffb,%eax
801045bc:	77 1a                	ja     801045d8 <argptr+0x48>
801045be:	01 c3                	add    %eax,%ebx
801045c0:	81 fb fc ff ff 7f    	cmp    $0x7ffffffc,%ebx
801045c6:	77 10                	ja     801045d8 <argptr+0x48>
    return -1;
  *pp = (char*)i;
801045c8:	8b 55 0c             	mov    0xc(%ebp),%edx
801045cb:	89 02                	mov    %eax,(%edx)
  return 0;
}
801045cd:	83 c4 24             	add    $0x24,%esp
  //if(size < 0 || (uint)i >= curproc->sz || (uint)i+size > curproc->sz)
    //return -1;
  if(size < 0 || (uint) i >=STACKTOP || (uint)i+size > STACKTOP)
    return -1;
...
801045d8:	83 c4 24             	add    $0x24,%esp
{
  int i;
  //struct proc *curproc = myproc();
...
801045f3:	83 ec 28             	sub    $0x28,%esp
  int addr;
  if(argint(n, &addr) < 0)
801045f6:	8d 45 f4             	lea    -0xc(%ebp),%eax
801045f9:	89 44 24 04          	mov    %eax,0x4(%esp)
801045fd:	8b 45 08             	mov    0x8(%ebp),%eax
80104600:	89 04 24             	mov    %eax,(%esp)
80104603:	e8 48 ff ff ff       	call   80104550 <argint>
80104608:	85 c0                	test   %eax,%eax
8010460a:	78 2b                	js     80104637 <argstr+0x47>
    return -1;
...
fetchstr(uint addr, char **pp)
{
  ...
  if(addr >= STACKTOP)
8010460f:	81 fa fb ff ff 7f    	cmp    $0x7ffffffb,%edx
80104615:	77 20                	ja     80104637 <argstr+0x47>
    return -1;
  *pp = (char*)addr;
80104617:	8b 4d 0c             	mov    0xc(%ebp),%ecx
8010461a:	89 d0                	mov    %edx,%eax
8010461c:	89 11                	mov    %edx,(%ecx)
  ep = (char*)STACKTOP;
  for(s = *pp; s < ep; s++){
    if(*s == 0)
8010461e:	80 3a 00             	cmpb   $0x0,(%edx)
80104621:	75 0a                	jne    8010462d <argstr+0x3d>
80104623:	eb 1b                	jmp    80104640 <argstr+0x50>
80104625:	8d 76 00             	lea    0x0(%esi),%esi
80104628:	80 38 00             	cmpb   $0x0,(%eax)
8010462b:	74 13                	je     80104640 <argstr+0x50>
...
80104630:	3d fb ff ff 7f       	cmp    $0x7ffffffb,%eax
80104635:	76 f1                	jbe    80104628 <argstr+0x38>
int
argstr(int n, char **pp)
{
  int addr;
...
80104655:	83 ec 10             	sub    $0x10,%esp
  int num;
  struct proc *curproc = myproc();
80104658:	e8 33 f0 ff ff       	call   80103690 <myproc>

  num = curproc->tf->eax;
8010465d:	8b 70 20             	mov    0x20(%eax),%esi
...
8010466d:	8b 14 85 e0 74 10 80 	mov    -0x7fef8b20(,%eax,4),%edx
...
80104688:	89 44 24 0c          	mov    %eax,0xc(%esp)
            curproc->pid, curproc->name, num);
8010468c:	8d 43 74             	lea    0x74(%ebx),%eax
...
80104696:	c7 04 24 b1 74 10 80 	movl   $0x801074b1,(%esp)
8010469d:	89 44 24 04          	mov    %eax,0x4(%esp)
801046a1:	e8 aa bf ff ff       	call   80100650 <cprintf>
            curproc->pid, curproc->name, num);
    curproc->tf->eax = -1;
801046a6:	8b 43 20             	mov    0x20(%ebx),%eax
...
801046c6:	83 ec 04             	sub    $0x4,%esp
  int fd;
  struct proc *curproc = myproc();
801046c9:	e8 c2 ef ff ff       	call   80103690 <myproc>

  for(fd = 0; fd < NOFILE; fd++){
801046ce:	31 d2                	xor    %edx,%edx
    if(curproc->ofile[fd] == 0){
801046d0:	8b 4c 90 30          	mov    0x30(%eax,%edx,4),%ecx
...
801046ec:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  for(fd = 0; fd < NOFILE; fd++){
    if(curproc->ofile[fd] == 0){
      curproc->ofile[fd] = f;
801046f0:	89 5c 90 30          	mov    %ebx,0x30(%eax,%edx,4)
      return fd;
    }
  }
  return -1;
...
8010471c:	89 4d bc             	mov    %ecx,-0x44(%ebp)
  ...
  if((dp = nameiparent(path, name)) == 0)
8010471f:	e8 ec d7 ff ff       	call   80101f10 <nameiparent>
...
80104731:	e8 6a cf ff ff       	call   801016a0 <ilock>
...
8010477b:	e8 80 d1 ff ff       	call   80101900 <iunlockput>
    panic("create: dirlink");
...
8010479d:	e8 6e cd ff ff       	call   80101510 <ialloc>
...
801047af:	e8 ec ce ff ff       	call   801016a0 <ilock>
  ip->major = major;
...
801047d0:	e8 0b ce ff ff       	call   801015e0 <iupdate>
...
801047f6:	e8 05 d1 ff ff       	call   80101900 <iunlockput>
...
80104866:	e8 f5 ba ff ff       	call   80100360 <panic>
  ...
  if((ip = ialloc(dp->dev, type)) == 0)
    panic("create: ialloc");
8010486b:	c7 04 24 40 75 10 80 	movl   $0x80107540,(%esp)
...
8010489a:	e8 b1 fc ff ff       	call   80104550 <argint>
...
801048a9:	e8 e2 ed ff ff       	call   80103690 <myproc>
801048ae:	8b 55 f4             	mov    -0xc(%ebp),%edx
801048b1:	8b 44 90 30          	mov    0x30(%eax,%edx,4),%eax
...
80104919:	e8 a2 c4 ff ff       	call   80100dc0 <filedup>
  return fd;
...
80104970:	e8 1b fc ff ff       	call   80104590 <argptr>
...
8010498d:	e8 8e c5 ff ff       	call   80100f20 <fileread>
}
80104992:	c9                   	leave  
80104993:	c3                   	ret    
...
801049c2:	e8 89 fb ff ff       	call   80104550 <argint>
...
801049e0:	e8 ab fb ff ff       	call   80104590 <argptr>
...
801049fd:	e8 be c5 ff ff       	call   80100fc0 <filewrite>
}
80104a02:	c9                   	leave  
80104a03:	c3                   	ret    
...
80104a23:	78 23                	js     80104a48 <sys_close+0x38>
    return -1;
  myproc()->ofile[fd] = 0;
80104a25:	e8 66 ec ff ff       	call   80103690 <myproc>
80104a2a:	8b 55 f0             	mov    -0x10(%ebp),%edx
80104a2d:	c7 44 90 30 00 00 00 	movl   $0x0,0x30(%eax,%edx,4)
80104a34:	00 
  fileclose(f);
80104a35:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104a38:	89 04 24             	mov    %eax,(%esp)
80104a3b:	e8 d0 c3 ff ff       	call   80100e10 <fileclose>
  return 0;
...
80104a7a:	e8 11 fb ff ff       	call   80104590 <argptr>
...
80104a90:	e8 3b c4 ff ff       	call   80100ed0 <filestat>
}
80104a95:	c9                   	leave  
80104a96:	c3                   	ret    
80104a97:	90                   	nop
...
80104ab7:	e8 34 fb ff ff       	call   801045f0 <argstr>
...
80104b17:	e8 c4 ca ff ff       	call   801015e0 <iupdate>
  iunlock(ip);
80104b1c:	89 1c 24             	mov    %ebx,(%esp)
80104b1f:	e8 5c cc ff ff       	call   80101780 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
80104b24:	8b 45 d0             	mov    -0x30(%ebp),%eax
80104b27:	89 7c 24 04          	mov    %edi,0x4(%esp)
80104b2b:	89 04 24             	mov    %eax,(%esp)
80104b2e:	e8 dd d3 ff ff       	call   80101f10 <nameiparent>
...
80104b3c:	e8 5f cb ff ff       	call   801016a0 <ilock>
...
80104b55:	e8 b6 d2 ff ff       	call   80101e10 <dirlink>
...
80104b61:	e8 9a cd ff ff       	call   80101900 <iunlockput>
  iput(ip);
80104b66:	89 1c 24             	mov    %ebx,(%esp)
80104b69:	e8 52 cc ff ff       	call   801017c0 <iput>

  end_op();
80104b6e:	e8 fd df ff ff       	call   80102b70 <end_op>
  ip->nlink--;
  iupdate(ip);
  iunlockput(ip);
  end_op();
...
80104b83:	e8 78 cd ff ff       	call   80101900 <iunlockput>
  end_op();
...
80104bd7:	e8 14 fa ff ff       	call   801045f0 <argstr>
80104bdc:	85 c0                	test   %eax,%eax
80104bde:	0f 88 76 01 00 00    	js     80104d5a <sys_unlink+0x19a>
    return -1;

  begin_op();
80104be4:	e8 17 df ff ff       	call   80102b00 <begin_op>
  if((dp = nameiparent(path, name)) == 0){
...
80104bf6:	e8 15 d3 ff ff       	call   80101f10 <nameiparent>
...
80104c0c:	e8 8f ca ff ff       	call   801016a0 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80104c11:	c7 44 24 04 5c 75 10 	movl   $0x8010755c,0x4(%esp)
80104c18:	80 
80104c19:	89 1c 24             	mov    %ebx,(%esp)
80104c1c:	e8 5f cf ff ff       	call   80101b80 <namecmp>
80104c21:	85 c0                	test   %eax,%eax
80104c23:	0f 84 21 01 00 00    	je     80104d4a <sys_unlink+0x18a>
80104c29:	c7 44 24 04 5b 75 10 	movl   $0x8010755b,0x4(%esp)
80104c30:	80 
80104c31:	89 1c 24             	mov    %ebx,(%esp)
80104c34:	e8 47 cf ff ff       	call   80101b80 <namecmp>
...
80104c4f:	e8 5c cf ff ff       	call   80101bb0 <dirlookup>
...
80104c61:	e8 3a ca ff ff       	call   801016a0 <ilock>
...
80104c8e:	e8 0d f6 ff ff       	call   801042a0 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
80104cac:	e8 9f cd ff ff       	call   80101a50 <writei>
...
80104ccb:	e8 30 cc ff ff       	call   80101900 <iunlockput>

  ip->nlink--;
80104cd0:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80104cd5:	89 1c 24             	mov    %ebx,(%esp)
80104cd8:	e8 03 c9 ff ff       	call   801015e0 <iupdate>
  iunlockput(ip);
80104cdd:	89 1c 24             	mov    %ebx,(%esp)
80104ce0:	e8 1b cc ff ff       	call   80101900 <iunlockput>

  end_op();
80104ce5:	e8 86 de ff ff       	call   80102b70 <end_op>
...
80104d31:	e8 1a cc ff ff       	call   80101950 <readi>
...
80104d45:	e8 b6 cb ff ff       	call   80101900 <iunlockput>
  end_op();
...
80104d50:	e8 ab cb ff ff       	call   80101900 <iunlockput>
  end_op();
80104d55:	e8 16 de ff ff       	call   80102b70 <end_op>
  return -1;
}
...
80104d73:	e8 68 c8 ff ff       	call   801015e0 <iupdate>
80104d78:	e9 48 ff ff ff       	jmp    80104cc5 <sys_unlink+0x105>
  ...
  for(off=2*sizeof(de); off<dp->size; off+=sizeof(de)){
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
80104d7d:	c7 04 24 80 75 10 80 	movl   $0x80107580,(%esp)
80104d84:	e8 d7 b5 ff ff       	call   80100360 <panic>
  ...
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
    panic("unlink: writei");
80104d89:	c7 04 24 92 75 10 80 	movl   $0x80107592,(%esp)
80104d90:	e8 cb b5 ff ff       	call   80100360 <panic>
  ...
  if(ip->nlink < 1)
    panic("unlink: nlink < 1");
80104d95:	c7 04 24 6e 75 10 80 	movl   $0x8010756e,(%esp)
...
80104dc7:	e8 24 f8 ff ff       	call   801045f0 <argstr>
...
80104de2:	e8 69 f7 ff ff       	call   80104550 <argint>
80104de7:	85 c0                	test   %eax,%eax
80104de9:	0f 88 b6 00 00 00    	js     80104ea5 <sys_open+0xf5>
    return -1;

  begin_op();
80104def:	e8 0c dd ff ff       	call   80102b00 <begin_op>
...
80104e04:	e8 e7 d0 ff ff       	call   80101ef0 <namei>
...
80104e16:	e8 85 c8 ff ff       	call   801016a0 <ilock>
...
80104e26:	e8 25 bf ff ff       	call   80100d50 <filealloc>
...
80104e47:	e8 34 c9 ff ff       	call   80101780 <iunlock>
  end_op();
80104e4c:	e8 1f dd ff ff       	call   80102b70 <end_op>
...
80104e9c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
    ...
    iunlockput(ip);
    end_op();
80104ea0:	e8 cb dc ff ff       	call   80102b70 <end_op>
  f->ip = ip;
  f->off = 0;
  f->readable = !(omode & O_WRONLY);
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
...
80104ecb:	e8 30 ca ff ff       	call   80101900 <iunlockput>
...
80104edb:	e8 30 bf ff ff       	call   80100e10 <fileclose>
...
80104f09:	e8 e2 f6 ff ff       	call   801045f0 <argstr>
...
80104f80:	e8 cb f5 ff ff       	call   80104550 <argint>
  struct inode *ip;
  char *path;
  int major, minor;
...
80104f97:	e8 b4 f5 ff ff       	call   80104550 <argint>
  char *path;
  int major, minor;
...
80104fbf:	e8 3c c9 ff ff       	call   80101900 <iunlockput>
  end_op();
80104fc4:	e8 a7 db ff ff       	call   80102b70 <end_op>
  return 0;
...
80104fcd:	8d 76 00             	lea    0x0(%esi),%esi
  ...
  if((argstr(0, &path)) < 0 ||
     ...
     (ip = create(path, T_DEV, major, minor)) == 0){
    end_op();
80104fd0:	e8 9b db ff ff       	call   80102b70 <end_op>
    return -1;
...
80105011:	e8 da ce ff ff       	call   80101ef0 <namei>
...
8010501f:	e8 7c c6 ff ff       	call   801016a0 <ilock>
  if(ip->type != T_DIR){
...
8010502c:	75 22                	jne    80105050 <sys_chdir+0x70>
  ...
  iunlock(ip);
8010502e:	e8 4d c7 ff ff       	call   80101780 <iunlock>
  iput(curproc->cwd);
80105033:	8b 46 70             	mov    0x70(%esi),%eax
80105036:	89 04 24             	mov    %eax,(%esp)
80105039:	e8 82 c7 ff ff       	call   801017c0 <iput>
  end_op();
8010503e:	e8 2d db ff ff       	call   80102b70 <end_op>
  curproc->cwd = ip;
  return 0;
80105043:	31 c0                	xor    %eax,%eax
  ...
  end_op();
  curproc->cwd = ip;
80105045:	89 5e 70             	mov    %ebx,0x70(%esi)
  return 0;
}
...
8010504f:	90                   	nop
  ...
  if(ip->type != T_DIR){
    iunlockput(ip);
80105050:	e8 ab c8 ff ff       	call   80101900 <iunlockput>
    end_op();
80105055:	e8 16 db ff ff       	call   80102b70 <end_op>
  iunlock(ip);
  iput(curproc->cwd);
  end_op();
  curproc->cwd = ip;
...
8010508d:	e8 5e f5 ff ff       	call   801045f0 <argstr>
...
801050ab:	e8 a0 f4 ff ff       	call   80104550 <argint>
...
801050db:	e8 c0 f1 ff ff       	call   801042a0 <memset>
  for(i=0;; i++){
    if(i >= NELEM(argv))
      return -1;
...
801050f0:	e8 fb f3 ff ff       	call   801044f0 <fetchint>
...
8010510a:	e8 01 f4 ff ff       	call   80104510 <fetchstr>
...
8010517d:	e8 0e f4 ff ff       	call   80104590 <argptr>
...
80105193:	e8 c8 df ff ff       	call   80103160 <pipealloc>
...
801051c9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
    if(fd0 >= 0)
      myproc()->ofile[fd0] = 0;
801051d0:	e8 bb e4 ff ff       	call   80103690 <myproc>
801051d5:	c7 44 98 30 00 00 00 	movl   $0x0,0x30(%eax,%ebx,4)
801051dc:	00 
    fileclose(rf);
801051dd:	8b 45 f0             	mov    -0x10(%ebp),%eax
801051e0:	89 04 24             	mov    %eax,(%esp)
801051e3:	e8 28 bc ff ff       	call   80100e10 <fileclose>
    fileclose(wf);
801051e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801051eb:	89 04 24             	mov    %eax,(%esp)
801051ee:	e8 1d bc ff ff       	call   80100e10 <fileclose>
    return -1;
  }
  fd[0] = fd0;
  fd[1] = fd1;
...
80105214:	e8 37 f3 ff ff       	call   80104550 <argint>
...
80105233:	e8 58 f3 ff ff       	call   80104590 <argptr>
...
80105249:	e8 92 1b 00 00       	call   80106de0 <shm_open>
}
8010524e:	c9                   	leave  
8010524f:	c3                   	ret    
int sys_shm_open(void) {
...
80105283:	e8 68 1b 00 00       	call   80106df0 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
{
  return fork();
801052a4:	e9 97 e5 ff ff       	jmp    80103840 <fork>
...
801052b3:	83 ec 08             	sub    $0x8,%esp
  exit();
801052b6:	e8 d5 e7 ff ff       	call   80103a90 <exit>
...
{
  return wait();
801052c4:	e9 e7 e9 ff ff       	jmp    80103cb0 <wait>
...
801052e4:	e8 67 f2 ff ff       	call   80104550 <argint>
...
801052f3:	e8 18 eb ff ff       	call   80103e10 <kill>
}
801052f8:	c9                   	leave  
801052f9:	c3                   	ret    
...
80105313:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105316:	e8 75 e3 ff ff       	call   80103690 <myproc>
...
8010533c:	78 22                	js     80105360 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
8010533e:	e8 4d e3 ff ff       	call   80103690 <myproc>
  if(growproc(n) < 0)
...
8010534b:	e8 80 e4 ff ff       	call   801037d0 <growproc>
...
80105385:	e8 c6 f1 ff ff       	call   80104550 <argint>
8010538a:	85 c0                	test   %eax,%eax
8010538c:	78 7e                	js     8010540c <sys_sleep+0x9c>
    return -1;
  acquire(&tickslock);
8010538e:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105395:	e8 c6 ed ff ff       	call   80104160 <acquire>
  ticks0 = ticks;
...
8010539a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ...
  acquire(&tickslock);
  ticks0 = ticks;
8010539d:	8b 1d c0 56 11 80    	mov    0x801156c0,%ebx
  while(ticks - ticks0 < n){
...
801053b0:	c7 44 24 04 80 4e 11 	movl   $0x80114e80,0x4(%esp)
801053b7:	80 
801053b8:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
801053bf:	e8 3c e8 ff ff       	call   80103c00 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801053c4:	a1 c0 56 11 80       	mov    0x801156c0,%eax
801053c9:	29 d8                	sub    %ebx,%eax
801053cb:	3b 45 f4             	cmp    -0xc(%ebp),%eax
801053ce:	73 28                	jae    801053f8 <sys_sleep+0x88>
    if(myproc()->killed){
801053d0:	e8 bb e2 ff ff       	call   80103690 <myproc>
801053d5:	8b 40 2c             	mov    0x2c(%eax),%eax
801053d8:	85 c0                	test   %eax,%eax
801053da:	74 d4                	je     801053b0 <sys_sleep+0x40>
      release(&tickslock);
801053dc:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
801053e3:	e8 68 ee ff ff       	call   80104250 <release>
      return -1;
...
801053f4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  ...
  release(&tickslock);
801053f8:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
801053ff:	e8 4c ee ff ff       	call   80104250 <release>
  return 0;
}
...
80105424:	83 ec 14             	sub    $0x14,%esp
  ...
  acquire(&tickslock);
80105427:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
8010542e:	e8 2d ed ff ff       	call   80104160 <acquire>
  xticks = ticks;
80105433:	8b 1d c0 56 11 80    	mov    0x801156c0,%ebx
  release(&tickslock);
80105439:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105440:	e8 0b ee ff ff       	call   80104250 <release>
  return xticks;
}
...
80105484:	66 89 0c c5 c2 4e 11 	mov    %cx,-0x7feeb13e(,%eax,8)
8010548b:	80 
8010548c:	c6 04 c5 c4 4e 11 80 	movb   $0x0,-0x7feeb13c(,%eax,8)
80105493:	00 
80105494:	c6 04 c5 c5 4e 11 80 	movb   $0x8e,-0x7feeb13b(,%eax,8)
8010549b:	8e 
8010549c:	66 89 14 c5 c0 4e 11 	mov    %dx,-0x7feeb140(,%eax,8)
801054a3:	80 
801054a4:	c1 ea 10             	shr    $0x10,%edx
801054a7:	66 89 14 c5 c6 4e 11 	mov    %dx,-0x7feeb13a(,%eax,8)
801054ae:	80 
void
tvinit(void)
{
...
801054c9:	c7 44 24 04 a1 75 10 	movl   $0x801075a1,0x4(%esp)
801054d0:	80 
801054d1:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
{
  int i;
  ...
  for(i = 0; i < 256; i++)
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
801054d8:	66 89 15 c2 50 11 80 	mov    %dx,0x801150c2
801054df:	66 a3 c0 50 11 80    	mov    %ax,0x801150c0
801054e5:	c1 e8 10             	shr    $0x10,%eax
801054e8:	c6 05 c4 50 11 80 00 	movb   $0x0,0x801150c4
801054ef:	c6 05 c5 50 11 80 ef 	movb   $0xef,0x801150c5
801054f6:	66 a3 c6 50 11 80    	mov    %ax,0x801150c6

  initlock(&tickslock, "time");
801054fc:	e8 6f eb ff ff       	call   80104070 <initlock>
}
80105501:	c9                   	leave  
80105502:	c3                   	ret    
...
8010551b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010551f:	b8 c0 4e 11 80       	mov    $0x80114ec0,%eax
...
80105552:	0f 84 d0 01 00 00    	je     80105728 <trap+0x1e8>
    if(myproc()->killed)
      exit();
    return;
  }
...
80105560:	ff 24 85 48 76 10 80 	jmp    *-0x7fef89b8(,%eax,4)
80105567:	90                   	nop
  }
  break;
...
80105568:	e8 23 e1 ff ff       	call   80103690 <myproc>
8010556d:	85 c0                	test   %eax,%eax
8010556f:	90                   	nop
80105570:	0f 84 2a 02 00 00    	je     801057a0 <trap+0x260>
80105576:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
8010557a:	0f 84 20 02 00 00    	je     801057a0 <trap+0x260>
...
8010558c:	e8 df e0 ff ff       	call   80103670 <cpuid>
...
8010559c:	e8 ef e0 ff ff       	call   80103690 <myproc>
...
801055a4:	e8 e7 e0 ff ff       	call   80103690 <myproc>
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055a9:	8b 4d d8             	mov    -0x28(%ebp),%ecx
...
801055b0:	8b 75 e0             	mov    -0x20(%ebp),%esi
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055b3:	8b 55 dc             	mov    -0x24(%ebp),%edx
801055b6:	89 7c 24 14          	mov    %edi,0x14(%esp)
801055ba:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
801055be:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801055c1:	83 c6 74             	add    $0x74,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055c4:	89 54 24 18          	mov    %edx,0x18(%esp)
            "eip 0x%x addr 0x%x--kill proc\n",
            myproc()->pid, myproc()->name, tf->trapno,
801055c8:	89 74 24 08          	mov    %esi,0x8(%esp)
    ...
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
801055cc:	89 4c 24 10          	mov    %ecx,0x10(%esp)
801055d0:	8b 40 18             	mov    0x18(%eax),%eax
801055d3:	c7 04 24 04 76 10 80 	movl   $0x80107604,(%esp)
...
801055de:	e8 6d b0 ff ff       	call   80100650 <cprintf>
    ...
    myproc()->killed = 1;
801055e3:	e8 a8 e0 ff ff       	call   80103690 <myproc>
801055e8:	c7 40 2c 01 00 00 00 	movl   $0x1,0x2c(%eax)
801055ef:	90                   	nop
  }
...
801055f0:	e8 9b e0 ff ff       	call   80103690 <myproc>
801055f5:	85 c0                	test   %eax,%eax
801055f7:	74 0c                	je     80105605 <trap+0xc5>
801055f9:	e8 92 e0 ff ff       	call   80103690 <myproc>
801055fe:	8b 50 2c             	mov    0x2c(%eax),%edx
...
80105605:	e8 86 e0 ff ff       	call   80103690 <myproc>
...
80105615:	83 78 14 04          	cmpl   $0x4,0x14(%eax)
...
80105629:	8b 40 2c             	mov    0x2c(%eax),%eax
...
8010563b:	0f 84 18 01 00 00    	je     80105759 <trap+0x219>
    exit();
}
...
8010565b:	75 a8                	jne    80105605 <trap+0xc5>
    exit();
8010565d:	e8 2e e4 ff ff       	call   80103a90 <exit>
...
80105680:	0f 20 d0             	mov    %cr2,%eax
  ...
  case T_PGFLT:
    ...
    faultadd = rcr2();
80105683:	a3 64 4e 11 80       	mov    %eax,0x80114e64
    curproc = myproc();
80105688:	e8 03 e0 ff ff       	call   80103690 <myproc>
...
8010568d:	8b 50 08             	mov    0x8(%eax),%edx
  ...
  case T_PGFLT:
    ...
    faultadd = rcr2();
    curproc = myproc();
80105690:	a3 60 4e 11 80       	mov    %eax,0x80114e60
    stackadd = STACKTOP - (curproc->numPages * PGSIZE);
80105695:	b8 fc ff ff 7f       	mov    $0x7ffffffc,%eax
8010569a:	c1 e2 0c             	shl    $0xc,%edx
8010569d:	29 d0                	sub    %edx,%eax
8010569f:	a3 b4 4e 11 80       	mov    %eax,0x80114eb4
  ...
  break;
801056a4:	e9 47 ff ff ff       	jmp    801055f0 <trap+0xb0>
801056a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
801056b0:	e8 bb df ff ff       	call   80103670 <cpuid>
801056b5:	85 c0                	test   %eax,%eax
801056b7:	0f 84 b3 00 00 00    	je     80105770 <trap+0x230>
...
801056c0:	e8 ab d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056c5:	e9 26 ff ff ff       	jmp    801055f0 <trap+0xb0>
...
801056e5:	e8 86 d0 ff ff       	call   80102770 <lapiceoi>
    break;
801056ea:	e9 01 ff ff ff       	jmp    801055f0 <trap+0xb0>
801056ef:	90                   	nop
  case T_IRQ0 + 7:
...
801056fc:	c7 04 24 ac 75 10 80 	movl   $0x801075ac,(%esp)
...
80105714:	e8 57 d0 ff ff       	call   80102770 <lapiceoi>
    break;
80105719:	e9 d2 fe ff ff       	jmp    801055f0 <trap+0xb0>
...
80105725:	eb 96                	jmp    801056bd <trap+0x17d>
80105727:	90                   	nop
80105728:	90                   	nop
...
80105735:	8b 70 2c             	mov    0x2c(%eax),%esi
80105738:	85 f6                	test   %esi,%esi
8010573a:	75 2c                	jne    80105768 <trap+0x228>
      exit();
    myproc()->tf = tf;
8010573c:	e8 4f df ff ff       	call   80103690 <myproc>
80105741:	89 58 20             	mov    %ebx,0x20(%eax)
    syscall();
80105744:	e8 07 ef ff ff       	call   80104650 <syscall>
    if(myproc()->killed)
80105749:	e8 42 df ff ff       	call   80103690 <myproc>
8010574e:	8b 48 2c             	mov    0x2c(%eax),%ecx
80105751:	85 c9                	test   %ecx,%ecx
80105753:	0f 84 e8 fe ff ff    	je     80105641 <trap+0x101>
    yield();
...
8010576d:	eb cd                	jmp    8010573c <trap+0x1fc>
8010576f:	90                   	nop
  }
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
80105770:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105777:	e8 e4 e9 ff ff       	call   80104160 <acquire>
      ticks++;
      wakeup(&ticks);
8010577c:	c7 04 24 c0 56 11 80 	movl   $0x801156c0,(%esp)
  ...
  case T_IRQ0 + IRQ_TIMER:
    if(cpuid() == 0){
      acquire(&tickslock);
      ticks++;
80105783:	83 05 c0 56 11 80 01 	addl   $0x1,0x801156c0
      wakeup(&ticks);
8010578a:	e8 11 e6 ff ff       	call   80103da0 <wakeup>
      release(&tickslock);
8010578f:	c7 04 24 80 4e 11 80 	movl   $0x80114e80,(%esp)
80105796:	e8 b5 ea ff ff       	call   80104250 <release>
8010579b:	e9 1d ff ff ff       	jmp    801056bd <trap+0x17d>
...
801057a6:	e8 c5 de ff ff       	call   80103670 <cpuid>
...
801057ba:	c7 04 24 d0 75 10 80 	movl   $0x801075d0,(%esp)
801057c1:	89 44 24 04          	mov    %eax,0x4(%esp)
801057c5:	e8 86 ae ff ff       	call   80100650 <cprintf>
              tf->trapno, cpuid(), tf->eip, rcr2());
      panic("trap");
801057ca:	c7 04 24 a6 75 10 80 	movl   $0x801075a6,(%esp)
...
80105837:	e8 54 cf ff ff       	call   80102790 <microdelay>
{
  int i;
...
801058c7:	00 
  ...
  for(p="xv6...\n"; *p; p++)
801058c8:	bb 10 77 10 80       	mov    $0x80107710,%ebx
...
801058d4:	e8 c7 c9 ff ff       	call   801022a0 <ioapicenable>
...
80105916:	6a 00                	push   $0x0
  jmp alltraps
80105918:	e9 30 fb ff ff       	jmp    8010544d <alltraps>
...
8010591f:	6a 01                	push   $0x1
  jmp alltraps
80105921:	e9 27 fb ff ff       	jmp    8010544d <alltraps>
...
80105928:	6a 02                	push   $0x2
  jmp alltraps
8010592a:	e9 1e fb ff ff       	jmp    8010544d <alltraps>
...
80105931:	6a 03                	push   $0x3
  jmp alltraps
80105933:	e9 15 fb ff ff       	jmp    8010544d <alltraps>
...
8010593a:	6a 04                	push   $0x4
  jmp alltraps
8010593c:	e9 0c fb ff ff       	jmp    8010544d <alltraps>
...
80105965:	6a 09                	push   $0x9
  jmp alltraps
80105967:	e9 e1 fa ff ff       	jmp    8010544d <alltraps>
...
8010596c:	6a 0a                	push   $0xa
  jmp alltraps
8010596e:	e9 da fa ff ff       	jmp    8010544d <alltraps>
...
80105973:	6a 0b                	push   $0xb
  jmp alltraps
80105975:	e9 d3 fa ff ff       	jmp    8010544d <alltraps>
...
80105988:	6a 0e                	push   $0xe
  jmp alltraps
8010598a:	e9 be fa ff ff       	jmp    8010544d <alltraps>
...
801059a1:	6a 11                	push   $0x11
  jmp alltraps
801059a3:	e9 a5 fa ff ff       	jmp    8010544d <alltraps>
...
801059aa:	6a 12                	push   $0x12
  jmp alltraps
801059ac:	e9 9c fa ff ff       	jmp    8010544d <alltraps>
...
801059b3:	6a 13                	push   $0x13
  jmp alltraps
801059b5:	e9 93 fa ff ff       	jmp    8010544d <alltraps>
...
801059bc:	6a 14                	push   $0x14
  jmp alltraps
801059be:	e9 8a fa ff ff       	jmp    8010544d <alltraps>
...
801059c5:	6a 15                	push   $0x15
  jmp alltraps
801059c7:	e9 81 fa ff ff       	jmp    8010544d <alltraps>
...
801059ce:	6a 16                	push   $0x16
  jmp alltraps
801059d0:	e9 78 fa ff ff       	jmp    8010544d <alltraps>
...
801059d7:	6a 17                	push   $0x17
  jmp alltraps
801059d9:	e9 6f fa ff ff       	jmp    8010544d <alltraps>
...
801059e0:	6a 18                	push   $0x18
  jmp alltraps
801059e2:	e9 66 fa ff ff       	jmp    8010544d <alltraps>
...
801059e9:	6a 19                	push   $0x19
  jmp alltraps
801059eb:	e9 5d fa ff ff       	jmp    8010544d <alltraps>
...
801059f2:	6a 1a                	push   $0x1a
  jmp alltraps
801059f4:	e9 54 fa ff ff       	jmp    8010544d <alltraps>
...
801059fb:	6a 1b                	push   $0x1b
  jmp alltraps
801059fd:	e9 4b fa ff ff       	jmp    8010544d <alltraps>
...
80105a04:	6a 1c                	push   $0x1c
  jmp alltraps
80105a06:	e9 42 fa ff ff       	jmp    8010544d <alltraps>
...
80105a0d:	6a 1d                	push   $0x1d
  jmp alltraps
80105a0f:	e9 39 fa ff ff       	jmp    8010544d <alltraps>
...
80105a16:	6a 1e                	push   $0x1e
  jmp alltraps
80105a18:	e9 30 fa ff ff       	jmp    8010544d <alltraps>
...
80105a1f:	6a 1f                	push   $0x1f
  jmp alltraps
80105a21:	e9 27 fa ff ff       	jmp    8010544d <alltraps>
...
80105a28:	6a 20                	push   $0x20
  jmp alltraps
80105a2a:	e9 1e fa ff ff       	jmp    8010544d <alltraps>
...
80105a31:	6a 21                	push   $0x21
  jmp alltraps
80105a33:	e9 15 fa ff ff       	jmp    8010544d <alltraps>
...
80105a3a:	6a 22                	push   $0x22
  jmp alltraps
80105a3c:	e9 0c fa ff ff       	jmp    8010544d <alltraps>
...
80105a43:	6a 23                	push   $0x23
  jmp alltraps
80105a45:	e9 03 fa ff ff       	jmp    8010544d <alltraps>
...
80105a4c:	6a 24                	push   $0x24
  jmp alltraps
80105a4e:	e9 fa f9 ff ff       	jmp    8010544d <alltraps>
...
80105a55:	6a 25                	push   $0x25
  jmp alltraps
80105a57:	e9 f1 f9 ff ff       	jmp    8010544d <alltraps>
...
80105a5e:	6a 26                	push   $0x26
  jmp alltraps
80105a60:	e9 e8 f9 ff ff       	jmp    8010544d <alltraps>
...
80105a67:	6a 27                	push   $0x27
  jmp alltraps
80105a69:	e9 df f9 ff ff       	jmp    8010544d <alltraps>
...
80105a70:	6a 28                	push   $0x28
  jmp alltraps
80105a72:	e9 d6 f9 ff ff       	jmp    8010544d <alltraps>
...
80105a79:	6a 29                	push   $0x29
  jmp alltraps
80105a7b:	e9 cd f9 ff ff       	jmp    8010544d <alltraps>
...
80105a82:	6a 2a                	push   $0x2a
  jmp alltraps
80105a84:	e9 c4 f9 ff ff       	jmp    8010544d <alltraps>
...
80105a8b:	6a 2b                	push   $0x2b
  jmp alltraps
80105a8d:	e9 bb f9 ff ff       	jmp    8010544d <alltraps>
...
80105a94:	6a 2c                	push   $0x2c
  jmp alltraps
80105a96:	e9 b2 f9 ff ff       	jmp    8010544d <alltraps>
...
80105a9d:	6a 2d                	push   $0x2d
  jmp alltraps
80105a9f:	e9 a9 f9 ff ff       	jmp    8010544d <alltraps>
...
80105aa6:	6a 2e                	push   $0x2e
  jmp alltraps
80105aa8:	e9 a0 f9 ff ff       	jmp    8010544d <alltraps>
...
80105aaf:	6a 2f                	push   $0x2f
  jmp alltraps
80105ab1:	e9 97 f9 ff ff       	jmp    8010544d <alltraps>
...
80105ab8:	6a 30                	push   $0x30
  jmp alltraps
80105aba:	e9 8e f9 ff ff       	jmp    8010544d <alltraps>
...
80105ac1:	6a 31                	push   $0x31
  jmp alltraps
80105ac3:	e9 85 f9 ff ff       	jmp    8010544d <alltraps>
...
80105aca:	6a 32                	push   $0x32
  jmp alltraps
80105acc:	e9 7c f9 ff ff       	jmp    8010544d <alltraps>
...
80105ad3:	6a 33                	push   $0x33
  jmp alltraps
80105ad5:	e9 73 f9 ff ff       	jmp    8010544d <alltraps>
...
80105adc:	6a 34                	push   $0x34
  jmp alltraps
80105ade:	e9 6a f9 ff ff       	jmp    8010544d <alltraps>
...
80105ae5:	6a 35                	push   $0x35
  jmp alltraps
80105ae7:	e9 61 f9 ff ff       	jmp    8010544d <alltraps>
...
80105aee:	6a 36                	push   $0x36
  jmp alltraps
80105af0:	e9 58 f9 ff ff       	jmp    8010544d <alltraps>
...
80105af7:	6a 37                	push   $0x37
  jmp alltraps
80105af9:	e9 4f f9 ff ff       	jmp    8010544d <alltraps>
...
80105b00:	6a 38                	push   $0x38
  jmp alltraps
80105b02:	e9 46 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b09:	6a 39                	push   $0x39
  jmp alltraps
80105b0b:	e9 3d f9 ff ff       	jmp    8010544d <alltraps>
...
80105b12:	6a 3a                	push   $0x3a
  jmp alltraps
80105b14:	e9 34 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b1b:	6a 3b                	push   $0x3b
  jmp alltraps
80105b1d:	e9 2b f9 ff ff       	jmp    8010544d <alltraps>
...
80105b24:	6a 3c                	push   $0x3c
  jmp alltraps
80105b26:	e9 22 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b2d:	6a 3d                	push   $0x3d
  jmp alltraps
80105b2f:	e9 19 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b36:	6a 3e                	push   $0x3e
  jmp alltraps
80105b38:	e9 10 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b3f:	6a 3f                	push   $0x3f
  jmp alltraps
80105b41:	e9 07 f9 ff ff       	jmp    8010544d <alltraps>
...
80105b48:	6a 40                	push   $0x40
  jmp alltraps
80105b4a:	e9 fe f8 ff ff       	jmp    8010544d <alltraps>
...
80105b51:	6a 41                	push   $0x41
  jmp alltraps
80105b53:	e9 f5 f8 ff ff       	jmp    8010544d <alltraps>
...
80105b5a:	6a 42                	push   $0x42
  jmp alltraps
80105b5c:	e9 ec f8 ff ff       	jmp    8010544d <alltraps>
...
80105b63:	6a 43                	push   $0x43
  jmp alltraps
80105b65:	e9 e3 f8 ff ff       	jmp    8010544d <alltraps>
...
80105b6c:	6a 44                	push   $0x44
  jmp alltraps
80105b6e:	e9 da f8 ff ff       	jmp    8010544d <alltraps>
...
80105b75:	6a 45                	push   $0x45
  jmp alltraps
80105b77:	e9 d1 f8 ff ff       	jmp    8010544d <alltraps>
...
80105b7e:	6a 46                	push   $0x46
  jmp alltraps
80105b80:	e9 c8 f8 ff ff       	jmp    8010544d <alltraps>
...
80105b87:	6a 47                	push   $0x47
  jmp alltraps
80105b89:	e9 bf f8 ff ff       	jmp    8010544d <alltraps>
...
80105b90:	6a 48                	push   $0x48
  jmp alltraps
80105b92:	e9 b6 f8 ff ff       	jmp    8010544d <alltraps>
...
80105b99:	6a 49                	push   $0x49
  jmp alltraps
80105b9b:	e9 ad f8 ff ff       	jmp    8010544d <alltraps>
...
80105ba2:	6a 4a                	push   $0x4a
  jmp alltraps
80105ba4:	e9 a4 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bab:	6a 4b                	push   $0x4b
  jmp alltraps
80105bad:	e9 9b f8 ff ff       	jmp    8010544d <alltraps>
...
80105bb4:	6a 4c                	push   $0x4c
  jmp alltraps
80105bb6:	e9 92 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bbd:	6a 4d                	push   $0x4d
  jmp alltraps
80105bbf:	e9 89 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bc6:	6a 4e                	push   $0x4e
  jmp alltraps
80105bc8:	e9 80 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bcf:	6a 4f                	push   $0x4f
  jmp alltraps
80105bd1:	e9 77 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bd8:	6a 50                	push   $0x50
  jmp alltraps
80105bda:	e9 6e f8 ff ff       	jmp    8010544d <alltraps>
...
80105be1:	6a 51                	push   $0x51
  jmp alltraps
80105be3:	e9 65 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bea:	6a 52                	push   $0x52
  jmp alltraps
80105bec:	e9 5c f8 ff ff       	jmp    8010544d <alltraps>
...
80105bf3:	6a 53                	push   $0x53
  jmp alltraps
80105bf5:	e9 53 f8 ff ff       	jmp    8010544d <alltraps>
...
80105bfc:	6a 54                	push   $0x54
  jmp alltraps
80105bfe:	e9 4a f8 ff ff       	jmp    8010544d <alltraps>
...
80105c05:	6a 55                	push   $0x55
  jmp alltraps
80105c07:	e9 41 f8 ff ff       	jmp    8010544d <alltraps>
...
80105c0e:	6a 56                	push   $0x56
  jmp alltraps
80105c10:	e9 38 f8 ff ff       	jmp    8010544d <alltraps>
...
80105c17:	6a 57                	push   $0x57
  jmp alltraps
80105c19:	e9 2f f8 ff ff       	jmp    8010544d <alltraps>
...
80105c20:	6a 58                	push   $0x58
  jmp alltraps
80105c22:	e9 26 f8 ff ff       	jmp    8010544d <alltraps>
...
80105c29:	6a 59                	push   $0x59
  jmp alltraps
80105c2b:	e9 1d f8 ff ff       	jmp    8010544d <alltraps>
...
80105c32:	6a 5a                	push   $0x5a
  jmp alltraps
80105c34:	e9 14 f8 ff ff       	jmp    8010544d <alltraps>
...
80105c3b:	6a 5b                	push   $0x5b
  jmp alltraps
80105c3d:	e9 0b f8 ff ff       	jmp    8010544d <alltraps>
...
80105c44:	6a 5c                	push   $0x5c
  jmp alltraps
80105c46:	e9 02 f8 ff ff       	jmp    8010544d <alltraps>
...
80105c4d:	6a 5d                	push   $0x5d
  jmp alltraps
80105c4f:	e9 f9 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c56:	6a 5e                	push   $0x5e
  jmp alltraps
80105c58:	e9 f0 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c5f:	6a 5f                	push   $0x5f
  jmp alltraps
80105c61:	e9 e7 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c68:	6a 60                	push   $0x60
  jmp alltraps
80105c6a:	e9 de f7 ff ff       	jmp    8010544d <alltraps>
...
80105c71:	6a 61                	push   $0x61
  jmp alltraps
80105c73:	e9 d5 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c7a:	6a 62                	push   $0x62
  jmp alltraps
80105c7c:	e9 cc f7 ff ff       	jmp    8010544d <alltraps>
...
80105c83:	6a 63                	push   $0x63
  jmp alltraps
80105c85:	e9 c3 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c8c:	6a 64                	push   $0x64
  jmp alltraps
80105c8e:	e9 ba f7 ff ff       	jmp    8010544d <alltraps>
...
80105c95:	6a 65                	push   $0x65
  jmp alltraps
80105c97:	e9 b1 f7 ff ff       	jmp    8010544d <alltraps>
...
80105c9e:	6a 66                	push   $0x66
  jmp alltraps
80105ca0:	e9 a8 f7 ff ff       	jmp    8010544d <alltraps>
...
80105ca7:	6a 67                	push   $0x67
  jmp alltraps
80105ca9:	e9 9f f7 ff ff       	jmp    8010544d <alltraps>
...
80105cb0:	6a 68                	push   $0x68
  jmp alltraps
80105cb2:	e9 96 f7 ff ff       	jmp    8010544d <alltraps>
...
80105cb9:	6a 69                	push   $0x69
  jmp alltraps
80105cbb:	e9 8d f7 ff ff       	jmp    8010544d <alltraps>
...
80105cc2:	6a 6a                	push   $0x6a
  jmp alltraps
80105cc4:	e9 84 f7 ff ff       	jmp    8010544d <alltraps>
...
80105ccb:	6a 6b                	push   $0x6b
  jmp alltraps
80105ccd:	e9 7b f7 ff ff       	jmp    8010544d <alltraps>
...
80105cd4:	6a 6c                	push   $0x6c
  jmp alltraps
80105cd6:	e9 72 f7 ff ff       	jmp    8010544d <alltraps>
...
80105cdd:	6a 6d                	push   $0x6d
  jmp alltraps
80105cdf:	e9 69 f7 ff ff       	jmp    8010544d <alltraps>
...
80105ce6:	6a 6e                	push   $0x6e
  jmp alltraps
80105ce8:	e9 60 f7 ff ff       	jmp    8010544d <alltraps>
...
80105cef:	6a 6f                	push   $0x6f
  jmp alltraps
80105cf1:	e9 57 f7 ff ff       	jmp    8010544d <alltraps>
...
80105cf8:	6a 70                	push   $0x70
  jmp alltraps
80105cfa:	e9 4e f7 ff ff       	jmp    8010544d <alltraps>
...
80105d01:	6a 71                	push   $0x71
  jmp alltraps
80105d03:	e9 45 f7 ff ff       	jmp    8010544d <alltraps>
...
80105d0a:	6a 72                	push   $0x72
  jmp alltraps
80105d0c:	e9 3c f7 ff ff       	jmp    8010544d <alltraps>
...
80105d13:	6a 73                	push   $0x73
  jmp alltraps
80105d15:	e9 33 f7 ff ff       	jmp    8010544d <alltraps>
...
80105d1c:	6a 74                	push   $0x74
  jmp alltraps
80105d1e:	e9 2a f7 ff ff       	jmp    8010544d <alltraps>
...
80105d25:	6a 75                	push   $0x75
  jmp alltraps
80105d27:	e9 21 f7 ff ff       	jmp    8010544d <alltraps>
...
80105d2e:	6a 76                	push   $0x76
  jmp alltraps
80105d30:	e9 18 f7 ff ff       	jmp    8010544d <alltraps>
...
80105d37:	6a 77                	push   $0x77
  jmp alltraps
80105d39:	e9 0f f7 ff ff       	jmp    8010544d <alltraps>
...
80105d40:	6a 78                	push   $0x78
  jmp alltraps
80105d42:	e9 06 f7 ff ff       	jmp    8010544d <alltraps>
...
80105d49:	6a 79                	push   $0x79
  jmp alltraps
80105d4b:	e9 fd f6 ff ff       	jmp    8010544d <alltraps>
...
80105d52:	6a 7a                	push   $0x7a
  jmp alltraps
80105d54:	e9 f4 f6 ff ff       	jmp    8010544d <alltraps>
...
80105d64:	6a 7c                	push   $0x7c
  jmp alltraps
80105d66:	e9 e2 f6 ff ff       	jmp    8010544d <alltraps>
...
80105d6d:	6a 7d                	push   $0x7d
  jmp alltraps
80105d6f:	e9 d9 f6 ff ff       	jmp    8010544d <alltraps>
...
80105d76:	6a 7e                	push   $0x7e
  jmp alltraps
80105d78:	e9 d0 f6 ff ff       	jmp    8010544d <alltraps>
...
80106358:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010635d:	e9 eb f0 ff ff       	jmp    8010544d <alltraps>
...
80106364:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106369:	e9 df f0 ff ff       	jmp    8010544d <alltraps>
...
80106370:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106375:	e9 d3 f0 ff ff       	jmp    8010544d <alltraps>
...
8010637c:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106381:	e9 c7 f0 ff ff       	jmp    8010544d <alltraps>
...
801063d4:	e8 b7 c0 ff ff       	call   80102490 <kalloc>
...
801063f2:	e8 a9 de ff ff       	call   801042a0 <memset>
    // The permissions here are overly generous, but they can
    // be further restricted by the permissions in the page table
    // entries, if necessary.
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106463:	e8 78 be ff ff       	call   801022e0 <kfree>
      *pte = 0;
...
801064c3:	83 ec 18             	sub    $0x18,%esp
  ...
  c = &cpus[cpuid()];
801064c6:	e8 a5 d1 ff ff       	call   80103670 <cpuid>
...
801065f1:	c3                   	ret    
  ...
  for(;;){
    ...
    if(*pte & PTE_P)
      panic("remap");
801065f2:	c7 04 24 18 77 10 80 	movl   $0x80107718,(%esp)
...
80106600:	a1 c4 56 11 80       	mov    0x801156c4,%eax
...
8010662e:	0f 84 cd 00 00 00    	je     80106701 <switchuvm+0xe1>
  ...
  if(p->kstack == 0)
80106634:	8b 46 10             	mov    0x10(%esi),%eax
80106637:	85 c0                	test   %eax,%eax
80106639:	0f 84 da 00 00 00    	je     80106719 <switchuvm+0xf9>
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
8010663f:	8b 7e 0c             	mov    0xc(%esi),%edi
80106642:	85 ff                	test   %edi,%edi
80106644:	0f 84 c3 00 00 00    	je     8010670d <switchuvm+0xed>
    panic("switchuvm: no pgdir");

  pushcli();
8010664a:	e8 d1 da ff ff       	call   80104120 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010664f:	e8 9c cf ff ff       	call   801035f0 <mycpu>
80106654:	89 c3                	mov    %eax,%ebx
80106656:	e8 95 cf ff ff       	call   801035f0 <mycpu>
8010665b:	89 c7                	mov    %eax,%edi
8010665d:	e8 8e cf ff ff       	call   801035f0 <mycpu>
...
801066a9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
  ...
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
                                sizeof(mycpu()->ts)-1, 0);
  mycpu()->gdt[SEG_TSS].s = 0;
801066ae:	e8 3d cf ff ff       	call   801035f0 <mycpu>
801066b3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
  mycpu()->ts.ss0 = SEG_KDATA << 3;
801066ba:	e8 31 cf ff ff       	call   801035f0 <mycpu>
801066bf:	b9 10 00 00 00       	mov    $0x10,%ecx
801066c4:	66 89 48 10          	mov    %cx,0x10(%eax)
  mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801066c8:	e8 23 cf ff ff       	call   801035f0 <mycpu>
801066cd:	8b 56 10             	mov    0x10(%esi),%edx
801066d0:	8d 8a 00 10 00 00    	lea    0x1000(%edx),%ecx
801066d6:	89 48 0c             	mov    %ecx,0xc(%eax)
  // setting IOPL=0 in eflags *and* iomb beyond the tss segment limit
  // forbids I/O instructions (e.g., inb and outb) from user space
  mycpu()->ts.iomb = (ushort) 0xFFFF;
801066d9:	e8 12 cf ff ff       	call   801035f0 <mycpu>
...
801066ea:	8b 46 0c             	mov    0xc(%esi),%eax
...
801066fb:	5d                   	pop    %ebp
  ...
  lcr3(V2P(p->pgdir));  // switch to process's address space
  popcli();
801066fc:	e9 df da ff ff       	jmp    801041e0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
void
switchuvm(struct proc *p)
{
  if(p == 0)
    panic("switchuvm: no process");
80106701:	c7 04 24 1e 77 10 80 	movl   $0x8010771e,(%esp)
80106708:	e8 53 9c ff ff       	call   80100360 <panic>
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
  if(p->pgdir == 0)
    panic("switchuvm: no pgdir");
8010670d:	c7 04 24 49 77 10 80 	movl   $0x80107749,(%esp)
...
switchuvm(struct proc *p)
{
  ...
  if(p->kstack == 0)
    panic("switchuvm: no kstack");
80106719:	c7 04 24 34 77 10 80 	movl   $0x80107734,(%esp)
...
8010674a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  ...
  mem = kalloc();
8010674d:	e8 3e bd ff ff       	call   80102490 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106765:	89 c3                	mov    %eax,%ebx
  memset(mem, 0, PGSIZE);
80106767:	e8 34 db ff ff       	call   801042a0 <memset>
...
801067a8:	5d                   	pop    %ebp
  ...
  mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
  memmove(mem, init, sz);
801067a9:	e9 92 db ff ff       	jmp    80104340 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
  char *mem;
  ...
  if(sz >= PGSIZE)
    panic("inituvm: more than a page");
801067ae:	c7 04 24 5d 77 10 80 	movl   $0x8010775d,(%esp)
...
8010683d:	e8 0e b1 ff ff       	call   80101950 <readi>
...
80106861:	c3                   	ret    
  ...
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
      panic("loaduvm: address should exist");
80106862:	c7 04 24 77 77 10 80 	movl   $0x80107777,(%esp)
80106869:	e8 f2 9a ff ff       	call   80100360 <panic>
{
  ...
  if((uint) addr % PGSIZE != 0)
    panic("loaduvm: addr must be page aligned");
8010686e:	c7 04 24 18 78 10 80 	movl   $0x80107818,(%esp)
...
801068cb:	e8 d0 d9 ff ff       	call   801042a0 <memset>
...
80106905:	76 29                	jbe    80106930 <allocuvm+0xb0>
    mem = kalloc();
80106907:	e8 84 bb ff ff       	call   80102490 <kalloc>
    if(mem == 0){
...
80106910:	75 a6                	jne    801068b8 <allocuvm+0x38>
      cprintf("allocuvm out of memory\n");
80106912:	c7 04 24 95 77 10 80 	movl   $0x80107795,(%esp)
...
8010693a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    ...
    if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
      cprintf("allocuvm out of memory (2)\n");
80106940:	c7 04 24 ad 77 10 80 	movl   $0x801077ad,(%esp)
...
801069ed:	e8 ee b8 ff ff       	call   801022e0 <kfree>
  uint i;
...
80106a02:	5d                   	pop    %ebp
  ...
  kfree((char*)pgdir);
80106a03:	e9 d8 b8 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
  uint i;
  ...
  if(pgdir == 0)
    panic("freevm: no pgdir");
80106a08:	c7 04 24 c9 77 10 80 	movl   $0x801077c9,(%esp)
...
80106a28:	e8 63 ba ff ff       	call   80102490 <kalloc>
...
80106a4b:	e8 50 d8 ff ff       	call   801042a0 <memset>
  if (P2V(PHYSTOP) > (void*)DEVSPACE)
    panic("PHYSTOP too high");
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106abb:	a3 c4 56 11 80       	mov    %eax,0x801156c4
// Switch h/w page table register to the kernel-only page table,
// for when no process is running.
void
switchkvm(void)
...
80106aeb:	c3                   	ret    
{
  ...
  if(pte == 0)
    panic("clearpteu");
80106aec:	c7 04 24 da 77 10 80 	movl   $0x801077da,(%esp)
...
80106b13:	0f 84 6d 01 00 00    	je     80106c86 <copyuvm+0x186>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106b3d:	e8 fe d7 ff ff       	call   80104340 <memmove>
...
80106b87:	0f 84 0c 01 00 00    	je     80106c99 <copyuvm+0x199>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106b8d:	8b 30                	mov    (%eax),%esi
80106b8f:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106b95:	0f 84 f2 00 00 00    	je     80106c8d <copyuvm+0x18d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
...
80106ba6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106bac:	e8 df b8 ff ff       	call   80102490 <kalloc>
...
80106bd0:	e8 bb ca ff ff       	call   80103690 <myproc>
80106bd5:	8b 58 04             	mov    0x4(%eax),%ebx
80106bd8:	81 fb fb ff ff 7f    	cmp    $0x7ffffffb,%ebx
80106bde:	76 5c                	jbe    80106c3c <copyuvm+0x13c>
80106be0:	e9 96 00 00 00       	jmp    80106c7b <copyuvm+0x17b>
...
80106c25:	e8 56 f9 ff ff       	call   80106580 <mappages>
80106c2a:	85 c0                	test   %eax,%eax
80106c2c:	78 8d                	js     80106bbb <copyuvm+0xbb>
    memmove(mem, (char*)P2V(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, V2P(mem), flags) < 0)
      goto bad;
  }
...
80106c3a:	77 3f                	ja     80106c7b <copyuvm+0x17b>
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
80106c3c:	8b 45 08             	mov    0x8(%ebp),%eax
80106c3f:	31 c9                	xor    %ecx,%ecx
80106c41:	89 da                	mov    %ebx,%edx
80106c43:	e8 48 f7 ff ff       	call   80106390 <walkpgdir>
80106c48:	85 c0                	test   %eax,%eax
80106c4a:	74 4d                	je     80106c99 <copyuvm+0x199>
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
80106c4c:	8b 30                	mov    (%eax),%esi
80106c4e:	f7 c6 01 00 00 00    	test   $0x1,%esi
80106c54:	74 37                	je     80106c8d <copyuvm+0x18d>
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c56:	89 f7                	mov    %esi,%edi
    flags = PTE_FLAGS(*pte);
80106c58:	81 e6 ff 0f 00 00    	and    $0xfff,%esi
80106c5e:	89 75 e4             	mov    %esi,-0x1c(%ebp)
  for(i = myproc()->st; i < STACKTOP; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
      panic("copyuvm: page not present");
    pa = PTE_ADDR(*pte);
80106c61:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
    flags = PTE_FLAGS(*pte);
    if((mem = kalloc()) == 0)
80106c67:	e8 24 b8 ff ff       	call   80102490 <kalloc>
80106c6c:	85 c0                	test   %eax,%eax
80106c6e:	89 c6                	mov    %eax,%esi
80106c70:	0f 85 72 ff ff ff    	jne    80106be8 <copyuvm+0xe8>
80106c76:	e9 40 ff ff ff       	jmp    80106bbb <copyuvm+0xbb>
...
80106c88:	e9 3b ff ff ff       	jmp    80106bc8 <copyuvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
    if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
      panic("copyuvm: pte should exist");
    if(!(*pte & PTE_P))
...
80106cbe:	e8 cd f6 ff ff       	call   80106390 <walkpgdir>
  if((*pte & PTE_P) == 0)
...
80106d8d:	80 
80106d8e:	c7 04 24 e0 56 11 80 	movl   $0x801156e0,(%esp)
80106d95:	e8 d6 d2 ff ff       	call   80104070 <initlock>
  acquire(&(shm_table.lock));
80106d9a:	c7 04 24 e0 56 11 80 	movl   $0x801156e0,(%esp)
80106da1:	e8 ba d3 ff ff       	call   80104160 <acquire>
80106da6:	b8 14 57 11 80       	mov    $0x80115714,%eax
80106dab:	90                   	nop
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106dc7:	3d 14 5a 11 80       	cmp    $0x80115a14,%eax
...
80106dce:	c7 04 24 e0 56 11 80 	movl   $0x801156e0,(%esp)
